...
[![Tests](https://img.shields.io/badge/tests-382-4c9a5a)](tests/)
...
```bash
ctest --test-dir build --output-on-failure    # 382 tests
...
| | |
|---|---|
| Unit and integration tests | **382** across 50 suites |
