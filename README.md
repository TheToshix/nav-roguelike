...
Пятьдесят четыре спрайта: десять тайлов и эффектов, девять предметов, шесть героев и двадцать девять тварей.
...
| **Бестиарий** | 21 вид с разными повадками: погоня, стрельба, бегство при ранении, призыв подмоги, хаотичное движение, поджог пола под собой; один — не всегда враг |
| **Боссы** | Восемь: четыре хозяина поясов и четыре меньших стража. У каждого своя механика и две-три фазы |
| **Предметы** | 31 вид снаряжения (12 из них — четыре набора со своими механиками), 8 зелий, 8 свитков; зелья и свитки не подписаны, пока их не испробуешь |
...
```bash
ctest --test-dir build --output-on-failure    # 403 тест
...
| | |
|---|---|
| Юнит- и интеграционных тестов | **403** в 50 наборах |
