...
Пятьдесят два спрайта: десять тайлов и эффектов, восемь предметов, шесть героев и двадцать восемь тварей.
...
| **Бестиарий** | 20 видов с разными повадками: погоня, стрельба, бегство при ранении, призыв подмоги, хаотичное движение, поджог пола под собой; один — не всегда враг |
...
```bash
ctest --test-dir build --output-on-failure    # 399 тест
...
| | |
|---|---|
| Юнит- и интеграционных тестов | **399** в 50 наборах |
